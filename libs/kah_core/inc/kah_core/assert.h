...
#define core_assert(condition)          if (!internal_core_assert_impl((condition), __FILE__, __FUNCTION__, __LINE__)) core_debug_break()
#define core_assert_msg(condition, ...) if (!internal_core_assert_msg_impl((condition), __FILE__, __FUNCTION__, __LINE__, __VA_ARGS__)) core_debug_break()
#define core_not_implemented()          if (!internal_core_not_implemented_impl(__FILE__, __FUNCTION__, __LINE__)) core_debug_break()
#define core_sanity()                   if (!internal_core_not_implemented_impl(__FILE__, __FUNCTION__, __LINE__)) core_debug_break()
#define core_sanity_msg(...)            if (!internal_core_not_implemented_impl(__FILE__, __FUNCTION__, __LINE__, __VA_ARGS__))) core_debug_break()
#else
